...
using static WebSec3_IPN.Services.ReCAPTCHA;

namespace WebSec3_IPN.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public RegisterModel(
            ...
            IEmailSender emailSender, IConfiguration configuration, ApplicationDbContext context, IEmailService emailService)
        {
